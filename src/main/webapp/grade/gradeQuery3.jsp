...
<META http-equiv="Content-Type" content="text/jspl; charset=UTF-8"><LINK rel="stylesheet" href="<%=request.getContextPath() %>/webep/css/style.css" type="text/css">
</HEAD>
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD width="35%">										
										<s:property value="cla.claId"/>
									</TD>
									<TD width="15%">	班级名称：
									</TD>
									<TD width="35%">										
										 <s:property value="cla.claName"/>
									</TD>
								</TR>		
							</TABLE>
						</TD>
						...
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
												...
												<s:iterator var ="plans" value="cla.tbPlans">
													<TD class="ItemTitle" width="12%">	<a href="<%=request.getContextPath() %>/grade/gradeQuery5.jsp">
													<s:property value="#plans.planName"/> </a>
													</TD>
												</s:iterator>
							   ...
							   <s:iterator var="stu" value="cla.tbStudents">
							   <tr align="middle" class="ItemBody">
							       <td class="ItemBody" height="20" align="left">${stu.stuName}</td>
							       
								       <s:iterator var="mark" value="#stu.grades">
