							...
							<TABLE border="0" cellpadding="4" cellspacing="2">
								<TR>
									<TD align="center" class="sys"><A href="Index.htm"
										class="syslink">退出登录</A> <A href="pass_TbUser.action"
		...
		<TR>
			<TD width="250" valign="top">
				<TABLE align="center" border="0" class="top" height="217"
					width="210">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>个人信息</B></TD>
					</TR>
					<TR>
						<TD height="200" width="100%">
							<TABLE align="center" border="1" bordercolor="#999999"
								...
								<TR bordercolor="#eaeaea">
									<TD>姓名：<s:property value="userName" /></TD>
								</TR>
								<TR bordercolor="#eaeaea">
									<TD>性别：<s:property value="userSex" /></TD>
								</TR>
								<TR bordercolor="#eaeaea">
									<TD>帐户号：<s:property value="userAccount" /></TD>
								</TR>
								<TR bordercolor="#eaeaea">
									<TD>帐户类型：<s:property value="userType" /></TD>
								</TR>
								<TR bordercolor="#eaeaea">
									<TD>上次登陆时间：</TD>
								</TR>
								<TR bordercolor="#eaeaea">
									<TD align="center"><s:property value="userLasttime" /></TD>
								</TR>
							</TABLE></TD>
					</TR>
				</TABLE></TD>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" height="217" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>管理信息</B></TD>
					</TR>
					<TR>
						<TD width="100%">
							<TABLE align="center" width="97%">
								<TR>
									<TD height="30"><STRONG>等待批阅的考试计划：</STRONG></TD>
								</TR>
								<TR>
										...
										<TABLE align="center" border="0" class="ItemList" height="20"
											width="100%">
										 	<TR height="24" align="middle">
												<TD class="ItemTitle" height="20" width="14%">考试计划编号</TD>
												<TD class="ItemTitle" width="14%">考试计划名称</TD>
												<TD class="ItemTitle" width="14%">考试时间</TD>
												<TD class="ItemTitle" width="14%">考试方案名称</TD>
												<TD class="ItemTitle" width="14%">考试班级</TD>
												<TD class="ItemTitle" width="14%">批阅截至时间</TD>
												<TD class="ItemTitle" width="14%">操作</TD>
											</TR>

											<!--  <TD class="ItemBody" height="20"><a href='examProject/examProjectQuery3.htm'>ISSTCWH_J001_01</a>
												</TD>
												-->

											<s:iterator value="tbplan" var="p">
												<TR align="middle" >
													<TD >
													<s:property value="#p.planId" /></TD>
													<TD><s:property value="#p.planName" /></TD>
													
													<TD><s:property value="#p.planStarttime" /></TD>
													<TD><s:property value="#p.tbPrecept.preName" /></TD>
													<TD><s:property value="#p.tbClass.claName" /></TD>
													<TD ><s:property value="#p.palnEnddate" /></TD>
													<TD ><INPUT type="button" name="joinExam" value="成绩批阅"  onclick="gradeCheck()"></TD>
											</s:iterator>
										</TABLE>
									</TD>
								</TR>
					...
					<TR>
						<TD width="100%">
							<TABLE align="center" width="97%">
								...
								<TR>
									<TD height="40" width="96%" valign="top">
										<TABLE align="left" border="0" class="ItemList" height="20"
											width="100%">
											<TR height="24" align="middle">
											...
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20">	<a
													href='quesLib/quesLibQuery2.htm'>QF20051128001</a>
												</TD>
												<TD class="ItemBody">	选择题
												</TD>
												<TD class="ItemBody">	Java基础
												</TD>
												<TD class="ItemBody">	周明星
												</TD>
												<TD class="ItemBody">	2005-09-20 09:00
												</TD>
												<TD class="ItemBody">	自动批阅
												</TD>
												<TD class="ItemBody">	已保存
												</TD>
											</TR>
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20">	<a
													href='quesLib/quesLibQuery2.htm'>QF20051128002</a>
												</TD>
												<TD class="ItemBody">	选择题
												</TD>
												<TD class="ItemBody">	Java高级编程
												</TD>
												<TD class="ItemBody">	周明星
												</TD>
												<TD class="ItemBody">	2005-09-20 09:00
	...
	<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<TR>
			<TD height="25" class="pagefoot"><FONT
				face="Arial, Helvetica, sans-serif">&copy;</FONT> 2005-2007  版权所有 软通动力信息技术有限公司 Powered by 软通动力武汉开发中心
			</TD>
		</TR>
	</TABLE>
</BODY>
