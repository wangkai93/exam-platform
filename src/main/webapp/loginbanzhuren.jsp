							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
											...
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20"><a href='examProject\examProjectIssue2.htm'>ISSTCWH_J001_01</a>
												</TD>
												...
												<TD class="ItemBody" align="left">java一班
												</TD>
												<TD class="ItemBody">2005-11-27 09:00
												</TD>
						...
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
											...
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20">	<a href='grade/gradeIssue1.htm'> ISSTCWH_J001_01</a>
												</TD>
												<TD class="ItemBody" align="left">	Java基础 
												</TD>
												<TD class="ItemBody">	ISSTCWH_S001
												</TD>
												<TD class="ItemBody">	2005-11-20 09:00－11:00
												</TD>
