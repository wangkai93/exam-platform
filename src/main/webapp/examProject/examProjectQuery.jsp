						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD width="35%">										
										<INPUT class=box name="examNo" size=20 maxLength=20 >
									</TD>
									<TD width="15%">	考试计划名称：
									</TD>
									<TD>
							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
											...
											<s:iterator value="" var="">
												<TD class="ItemBody" height="20"><a href='.\examProject\examProjectQuery2.jsp'>
												<s:property value=""/>
												</a>
												</TD>
												...
												<TD class="ItemBody"><a href='.\examScheme\examSchemeQuery3.htm' >
												<s:property value=""/>
												</a>
												</TD>
												<TD class="ItemBody" align="left"><a href='.\class\classQuery3.htm'>
												<s:property value=""/>
												</a>
												</TD>
												<TD class="ItemBody">
...
function next()
{	
	document.location.href='examProjectQuery.htm'; 
}
</SCRIPT>
