   						...
   						<TD>
   							<TABLE align="center" border="0" width="90%">
   								<TR>
									...
									<INPUT class="box" name="Discribe" size="20" maxLength="20" value="java高级编程">
   									</TD>
   							...
   							<TABLE align="center" border="0" width="90%">
   								<TR>
									...
									<TD width="15%">	班级名称：
   									...
   									<TD width="35%">
									<INPUT class="box" name="Discribe" size="20" maxLength="20" value="java一班" readonly="true">&nbsp;
									 <a >
				            ...
				            <INPUT class="box" name="plan.palnEnddate" size="20" maxLength="20" value="2005-09-20 11:30" readonly="true">&nbsp;<A href="javascript:show_calendar('form1.TestTime');" onmouseout="window.status='';true;" onmouseover="window.status='Date Picker';true;"><IMG name="button" src='./webep/calendar.gif' width=16 height=15 border=0 align="absmiddle"></A>
								...
								<TR>
									...
									<TD>	批阅方式：
   									...
   									<TD>
									<font color="#808080"><INPUT class="box" name="Discribe" size="20" maxLength="20" value="老师批阅" readonly="true"></font>
   									</TD>
									<TD width="15%">	批阅人：
   									</TD>
										<TD>
				                    	<INPUT class="box" name="Discribe" size="20" maxLength="20" value="周明星" readonly="true" />&nbsp;<a ><img name="button" src='./webep/graphics/icon.gif' border=0 onclick="window.open('examProject/userList.jsp', 'SelectAnything', 'toolbar=no,menubar=no,resizable=no,location=no,width=520,height=450,scrollbars=yes', false);"></a>
				      <input type="hidden" id="" name="" />
									</TD>
   								</TR>
   							</TABLE>
...
{	
	...
	{
		alert("提交成功！"); 
		document.location.href='examProject/examProjectQuery.jsp'; 
	}
}
function save()
{	
	
		document.location.href='examProject/examProjectQuery2.jsp'; 
