							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
											...
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20">	<a href='examSchemeQuery2.htm'>QF20051128001</a>
												</TD>
												...
												<TD class="ItemBody">	已提交
												</TD>
											</TR>
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20">	<a href='examSchemeQuery2.htm'>QF20051128002</a>
												</TD>
...
function next()
{	
	document.location.href='examSchemeQuery.htm'; 
}
</SCRIPT>