		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>考试方案创建</B>
						</TD>
					</TR>
					<TR>
						<TD>&nbsp;	
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD>										
										<font color="#808080">2323123_4545 </font>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										考试方案名称：
		...
		<TABLE align="center" width="97%" border="0">
							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
												...
												<TD class="ItemTitle" width="5%">	编号
												</TD>
												<TD class="ItemTitle" width="18%">	题目范围
												</TD>
												<TD class="ItemTitle" width="10%">	题目难度
												</TD>
												...
												<TD class="ItemTitle" width="10%">	每题分数
												</TD>
												<TD class="ItemTitle" width="10%">	题量
												</TD>
												
												<TD class="ItemTitle" width="10%">	分数合计
												</TD>
											</TR>
											<TR align="middle" class="ItemBody">
												
												<TD class="ItemBody">	<a href="#">1</a>
												</TD>
											...
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20" colspan="6">	<FONT color="#FF0000">合  计</FONT>
												</TD>
												<TD class="ItemBody" align="right">	<FONT color="#FF0000"> </FONT>
												</TD>
												<TD class="ItemBody" align="right">	<FONT color="#FF0000">40</FONT>
												</TD>
												
												<TD class="ItemBody" align="right">	<FONT color="#FF0000">100</FONT>
												</TD>
											</TR>
							</TABLE>
				</TD>
					...
					<TR>
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									<TD align="right">
										<input class=button type=button name="bback" value=" 返 回 " onClick="back()">
									</TD>
								</TR>
							</TABLE>
						</TD>
