						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD width="35%">										
										<font color="#808080">邓 昆</font>
									</TD>
									<TD width="12%">	审核日期：
									</TD>
									<TD>										
										<font color="#808080">2005-12-01</font>
									</TD>
								</TR>
								<TR>
									<TD height="20" width="1%">
									...
									<TD width="35%">										
										<font color="#808080">已拒绝</font>
									</TD>
									<TD width="12%">	拒绝原因：
									</TD>
									<TD>										
										<font color="#808080">难度过大！</font>
									</TD>
								</TR>
							</TABLE>
						</TD>
...
{	
	...
	{
		alert("删除成功！"); 
		document.location.href='examSchemeQuery2.htm'; 
	}
}
function commit()
{	
