...
<HR width="98%">
						...
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
												...
												<TD class="ItemTitle" width="11%">	批阅方式
												</TD>
											...
											<TR align="middle" class="ItemBody">
												...
												<TD class="ItemBody" height="20">	<a href='../quesLib/quesLibQuery3.htm'>QF20051128001</a>
												</TD>
												<TD class="ItemBody">	选择题
												</TD>
												<TD class="ItemBody" align="left">	Java基础
												</TD>
												<TD class="ItemBody">	简单
												</TD>
											...
											<td width="3%" ><input type="checkbox"></td>
												...
												<TD class="ItemBody" height="20">	<a href='../quesLib/quesLibQuery3.htm'>QF20051128002</a>
												</TD>
												<TD class="ItemBody">	选择题
												</TD>
          ...
          class=SearchBar></SPAN></B></P>
					...
					<TR>
									...
									<INPUT class="button" type="button"  name="search" value=" 全 选" >								
