						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								...
								<TR>
									...
									<TD>										
										<font color="#808080">java 一班</font>
									</TD>
								</TR>
								<TR>
									<TD height="20">
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD colspan="2">	<font color="#808080">此班级有30名学生，全部为武汉工程大学的大四在校生。</font>
									</TD>
								</TR>
							...
							<TABLE align="center" border="0" width="90%">
								<TR>
									<TD align="right">
										...
										<input class=button type=reset name="bsave" value=" 返 回 " onclick="javascript:history.back(-1)">
									</TD>
								</TR>
							</TABLE>
						</TD>
