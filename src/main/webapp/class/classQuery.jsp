			...
			<TD align="left" valign="top">
						...
						<s:form>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD width="35%">										
										<INPUT class=box name="tbClasss.claId" size=20 maxLength=20 value="">
									</TD>
									<TD width="12%">	班级名称：
									</TD>
									<TD>										
										<INPUT class=box name="tbClasss.claName" size=20 maxLength=20 value="">
									</TD>
								</TR>
								<TR>
									<TD height="20">
									...
									<TD >										
										<INPUT class="box" name="tbUsers.userName" size="20" maxLength="20" value="">
									</TD>
									<TD>	班级状态
									</TD>
									<TD>										
				<select name="tbClasss.claState" >
				<option value='1' selected>全部</option>
				<s:iterator value="tbClass" var="tbClasss">
				<option value='<s:property value="#tbClasss.classId"/>' ><s:property value="#tbClasss.claState"/></option>
				</s:iterator>
				</select>
									</TD>
                               </TR>
				...
				<option value='<s:property value="#classType.classTypeId"/>'><s:property value="#classType.clatypeName"/></option>
								...
								<TR>
									...
									<TD colspan="3">	由：										
										<INPUT type="text" name="tbClasss.claIndate" class="box"  value=''>&nbsp;<A href="javascript:show_calendar('form1.TestTimeaaa');" onmouseout="window.status='';true;" onmouseover="window.status='Date Picker'; true;"><IMG name="button" src='../webep/calendar.gif' width=16 height=15 border=0 align="absmiddle"></A>
										&nbsp;&nbsp;&nbsp;&nbsp;到：										
										<INPUT type="text" name="tbClasss.claOutdate" class="box"  value=''>&nbsp;<A href="javascript:show_calendar('form1.TestTimeaaa');" onmouseout="window.status='';true;" onmouseover="window.status='Date Picker';true;"><IMG name="button" src='../webep/calendar.gif' width=16 height=15 border=0 align="absmiddle"></A>
									</TD>
								</TR>
								<TR>
									<TD height="20">
							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
											...
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20">	<a href="classQuery2.htm">ISSTCWH_J001</a>
												</TD>
												<TD class="ItemBody" align="left">	java 四班
												</TD>
												<TD class="ItemBody" align="left">	涂姝
												</TD>
												<TD class="ItemBody">	2005-11-28 
												</TD>
												<TD class="ItemBody">	2006-02-28  
												</TD>
											...
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20"><a href="classQuery2.jsp">ISSTCWH_J002</a>
												</TD>
												<TD class="ItemBody" align="left">	java 一班
												</TD>
												<TD class="ItemBody" align="left">	曹庭
												</TD>
