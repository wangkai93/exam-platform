					...
					<TR>
						<TD>
							...
							<TR>
									...
									<TD>										
										<INPUT class=box name="qlDifficultyNo" size=20 maxLength=20 value="">
									</TD>
								</TR>
								<TR>
									<TD height="20" width="1%">
									...
									<TD>										
										<INPUT class=box name="qlDifficultyName" size=20 maxLength=20 value="">
									</TD>
								</TR>
								...
								<TR>
									...
									<TD align="right">										
										...
										<INPUT class="button" type="button"  name="back" value=" 返 回 " onclick="next()"/>
									</TD>
								</TR>
							</TABLE>
						</TD>
...
{	
	document.location.href='../SysMangerAction!findThemeDifficulty'; 
}
</SCRIPT>