   							...
   							<TABLE align="center" border="0" width="90%">
								...
								<TR>
								    ...
								    <TD>	学生类型名称：
   									...
   									<TD>
									<INPUT class="box" name="Discribe" size="20" maxLength="20" value="插班生" type="Text">
   									</TD>
								</TR>
   							</TABLE>
   						</TD>
...
{	
	...
	{
		alert("更新成功！"); 
		document.location.href='studentTypeSetting.htm'; 
	}
}
function todelete()
{	
	...
	{
		alert("删除成功！"); 
		document.location.href='../SysMangerAction!findStudentType.action'; 
	}
}
function next()
{	
