...
<%=request.getContextPath()%>/webep/js/coolmenus4.js"></SCRIPT>
<SCRIPT language="JavaScript1.2" src="
<%=request.getContextPath()%>/webep/js/cm_addins.js"></SCRIPT>
	<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
		<TR>
			<TD>
				<TABLE width="100%" border="0" cellpadding="0" cellspacing="0" class="pagetop">
					<TR>
						<TD width="420" nowrap class="headerLogo"><IMG src="
<%=request.getContextPath()%>/webep/logo.gif"><IMG src="
<%=request.getContextPath()%>/webep/logo_js.gif">
						</TD>
						<TD class="welcome">
						</TD>
						...
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								...
								<TR align="middle" class="ItemBody">
								 <s:iterator value="de" var="d">
									<TD class="ItemBody" height="20"><A href="qlDifficultySetting3.jsp">
									<s:property value="#d.thedifId"/></A>
									</TD>
									<TD class="ItemBody"><s:property value="#d.thedifName"/>
									</TD>
								</TR></s:iterator>
							</TABLE>
						</TD>
...
{	
	document.location.href='setting/qlDifficultySetting2.jsp'; 
}
function create()
{	
