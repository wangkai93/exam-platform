					...
					<TR>
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								...
								<s:iterator var="ql" value="tts">
									<TD class="ItemBody" height="20"><A href="qlTypeSetting3.jsp">
									<s:property  value="#ql.thetypeId"/></A>
									</TD>
									<TD class="ItemBody" align="left">
									<s:property  value="#ql.thetypeName"/>
									</TD>
								</TR>
							</s:iterator>
...
{	
	document.location.href='setting/qlTypeSetting2.jsp'; 
}
function create()
{	
	document.location.href='setting/qlTypeSetting1.htm'; 
}
</SCRIPT>