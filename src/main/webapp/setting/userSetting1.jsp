		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>用户设置</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD>										
										<INPUT class=box name="userName" size=20 maxLength=20 value="">
									</TD>
									<TD width="9%">	姓名：
									</TD>
									<TD>										
								...
								<TR>
									...
									<TD>										
										<INPUT class=box name="password" size=20 maxLength=20 value="password" >
									</TD>
									<TD>	性别：
									</TD>
									<TD>										
				...
				<option value='3'>班主任</option>
								...
								<TR>
									...
									<TD colspan="3" align="right">										
										...
										<INPUT class="button" type="button"  name="search" value=" 返 回 " onclick="next()"/>
									</TD>
								</TR>
							</TABLE>
						</TD>
