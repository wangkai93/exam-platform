					...
					<TR>
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								...
								<s:iterator var="qr" value="tas">
									<TD class="ItemBody" height="20"><A href="qlRangeSetting3.jsp">
									<s:property value="#qr.theareaId"/>
									</A>
									</TD>
									<TD class="ItemBody" align="left">
									<s:property value="#qr.theareaName"/>	
									</TD>
								</TR></s:iterator>
							</TABLE>
						</TD>
...
{	
	document.location.href='setting/qlRangeSetting2.jsp'; 
}
function create()
{	
