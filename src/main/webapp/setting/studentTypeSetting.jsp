					...
					<TR>
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								...
								<s:iterator var="st" value="sts">
									<TD class="ItemBody" height="20"><A href="studentTypeSetting2.jsp">
									<s:property value="#st.stutypeId"/>
                                   </A>
									</TD>
									<TD class="ItemBody" align="left">
                                          <s:property value="#st.stutypeName"/>
									</TD>
								</TR>
								</s:iterator>						
							</TABLE>
...
{	
	document.location.href='studentTypeSetting1.jsp'; 
}
