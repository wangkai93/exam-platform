	...
	<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
		<TR>
			<TD>
				...
				<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
					<TR>
						<TD height="24" class="menuMain"><br>
						</TD>
					</TR>
					<TR>
						...
						<TD height="200" width="100%">
							<TABLE align="center" border="1" bordercolor="#999999"
								...
								<TR bordercolor="#eaeaea">
									<TD>用户姓名：<s:property value="userName" /></TD>
								</TR>
								<TR bordercolor="#eaeaea">
									<TD>性别：<s:property value="userSex" /></TD>
								</TR>
								<TR bordercolor="#eaeaea">
									<TD>用户帐号：<s:property value="userAccount" /></TD>
								</TR>
								<TR bordercolor="#eaeaea">
									<TD>用户类型：<s:property value="userType" /></TD>
								</TR>
						...
						<TR>
							<TD width="100%">
								...
								<TABLE align="center" width="97%">
									<TR>
										<TD height="30"><STRONG>最近新增用户：</STRONG></TD>
									</TR>
									<TR>
										<TD height="40" width="96%" valign="top">
											<TABLE align="center" border="1" height="30px" width="100%">
											...
											<s:iterator value="tbuser" var="u" >
													<TR align="middle" class="ItemBody">
														<TD class="ItemBody" height="20" align="left"><s:property value="#u.userAccount" /></td>
														<TD class="ItemBody" align="left"><s:property value="#u.userName" /></td>
														<TD class="ItemBody" align="left"><s:property value="#u.userSex" /></td>
														<TD class="ItemBody" align="left"><s:property value="#u.userType" /></td>
														<TD class="ItemBody" align="left"><s:property value="#u.userEmail" /></td>
														<TD class="ItemBody" align="left"><s:property value="#u.userIndate" /></td>
													</tr>
												</s:iterator>
											<!-- 
												<TD class="ItemBody" height="20" align="left"><em>szhang 
												</em></TD>
												<TD class="ItemBody" align="left"><em>
												</em></TD>
												<TD class="ItemBody"><em>男 
												</em></TD>
												<TD class="ItemBody" align="left"><em>班主任 
												</em></TD>
											
												<TD class="ItemBody" align="left"><em> szhang@163.com 
												</em></TD>
												<TD class="ItemBody"><em>													 
													2005-11-27 
												</em></TD>
											</TR>
														<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20" align="left"><em>wwang</em> 
												</TD>
