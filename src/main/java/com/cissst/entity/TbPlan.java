...
public class TbPlan implements java.io.Serializable {
	...
	private String planId;//考试计划编号
	private String planName;//考试计划名称
	private String planDesc;
	private String planStarttime;//考试开始时间
	private String planEndtime;//考试结束时间
	...
	public String toString() {
		return "TbPlan [planTbId=" + planTbId + ", tbUser=" + tbUser
				+ ", tbStateflag=" + tbStateflag + ", tbDel=" + tbDel
				+ ", tbPrecept=" + tbPrecept + ", tbClass=" + tbClass
				+ ", planId=" + planId + ", planName=" + planName
				+ ", planDesc=" + planDesc + ", planStarttime=" + planStarttime
				+ ", planEndtime=" + planEndtime + ", palnEnddate="
				+ palnEnddate + ", modType=" + modType + ", modState="
				+ modState +"]";
	}
